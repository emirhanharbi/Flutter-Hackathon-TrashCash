                  ...
                  child: Column(
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            controller: textEditingController,decoration: InputDecoration(border: OutlineInputBorder(borderSide: BorderSide(color: Colors.black.withOpacity(0.8))),
                              ...
                              hintText: 'Ödeme Yolu',suffixText: 'INR',hintStyle:TextStyle(fontWeight: FontWeight.w100,fontStyle: FontStyle.italic),suffixStyle: TextStyle(color: Colors.black)
                          ),
                          ),
                        ),
                      ),
                      ...
                      RaisedButton(onPressed: (){
                        openCheckout();
                      },child: Text('Öde',style: TextStyle(color: Colors.white),),color: Colors.black.withOpacity(0.8),shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0)))
                    ],
                  ),
                ),
              ),
                ...
                child: Container(height: 350, decoration: BoxDecoration(color: Colors.grey[200],borderRadius: BorderRadius.circular(8.0),
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(border: OutlineInputBorder(borderSide: BorderSide(color: Colors.black.withOpacity(0.8))),
                                ...
                                hintText: 'İş detayı ekle',hintStyle:TextStyle(fontWeight: FontWeight.w100,fontStyle: FontStyle.italic),suffixStyle: TextStyle(color: Colors.black)
                            ),
                          ),
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(border: OutlineInputBorder(borderSide: BorderSide(color: Colors.black.withOpacity(0.8))),
                                ...
                                hintText: 'Ekstra bilgi ekle',hintStyle:TextStyle(fontWeight: FontWeight.w100,fontStyle: FontStyle.italic),suffixStyle: TextStyle(color: Colors.black)
                            ),
                          ),
                        ...
                        if(address!=null&&pin!=null) {
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              ...
                              return AlertDialog(
                                title: new Text("Sipariş Başarısız"),
                                content: new Text("Devam etmek için bilgilerinizi girin"),
                                actions: <Widget>[
                      ...
                      },child: Text('Ara',style: TextStyle(color: Colors.white),),color: Colors.black,elevation: 4,shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0)))
                    ],
                  ),
                ),
              ),
