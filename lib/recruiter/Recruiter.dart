...
import 'package:plumbr/employee/CreateAccountemployee.dart';
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: -110, end: 0.0),
                        Pin(size: 53.0, middle: 0.5),
                        child: Text(
                          'Atıklarınz Değer Kazansın',
                          style: TextStyle(
                            fontFamily: 'Roboto',
                            fontSize: 22,
                            color: const Color(0xff3b3b3b),
