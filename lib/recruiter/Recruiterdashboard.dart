...
import 'package:plumbr/general/atikekle.dart';
...
// background:
          ...
          Pinned.fromPins(
            Pin(size: 183.0, middle: 0.3125),
            Pin(size: 33.0, middle: 0.255),
          ...
          Pinned.fromPins(
            ...
            child:
              ...
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 127.0, start: 10.0),
                  Pin(size: 20.0, middle: 2.8),
                  child: Text(
                    'Depo Sayısı: 12',
                    style: TextStyle(
                      fontFamily: 'Roboto',
                ...
                Pinned.fromPins(
                  Pin(size: 138.0, middle: 1.1),
                  Pin(size: 20.0, middle: 3),
                  child: Transform.rotate(
                    angle: 0.0175,
                    child: Text(
                      'Kapasite: +5000kg',
